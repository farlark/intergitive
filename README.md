...
>
> The app is unsigned, so macOS may refuse to open it on first launch. Either right-click → Open, or clear the quarantine flag: `xattr -dr com.apple.quarantine /path/to/intergitive.app`.
